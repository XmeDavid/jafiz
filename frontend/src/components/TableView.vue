...
const validateToken = async () => {
    return await fetch(`${import.meta.env.VITE_API_URL}/api/auth`, {
        headers: {
...
const fetchBoard = async (id: string) => {
    loading.value = true
    return await fetch(`${import.meta.env.VITE_API_URL}/api/${id}`, {
        headers: {
            'Authorization': sessionStorage.getItem('token') || ''
        }
...
const checkIn = async () => {
    loading.value = true
    return await fetch(`${import.meta.env.VITE_API_URL}/api/check_in`, {
        method: 'POST',
        headers: {
            'Authorization': sessionStorage.getItem('token') || ''
        }
...
const updateDescription = async () => {
    ...
    return await fetch(`${import.meta.env.VITE_API_URL}/api/description`, {
        method: 'POST',
        headers: {
...
<template>
    <div v-if="!loading && data" class="bg-gray-100 dark:bg-gray-900 ">
        ...
        <div class="flex flex-col items-center justify-center overflow-scroll">
            <div class="mt-12 shrink-0 flex justify-center items-center w-full p-10">
                <div class="text-center">
                    ...
                    <div class="flex flex-row">
                        ...
                        <svg v-if="!editingMode" @click="editingMode = !editingMode" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <svg v-if="editingMode" @click="updateDescription" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div class="flex flex-col items-center justify-center w-full mb-12">
                ...
                <div
                    class="flex flex-wrap gap-4 p-4 rounded-lg bg-white shadow-lg dark:bg-gray-800 max-w-screen-md mx-8 justify-center">
    ...
    <div v-else class="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
        <div class="animate-spin h-12 w-12 rounded-full border-t-2 border-gray-900 dark:border-gray-50"></div>
    </div>
</template>
<style scoped>
